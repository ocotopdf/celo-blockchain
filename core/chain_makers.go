...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Istanbul, db ethdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Istanbul) *types.Header {
	var time uint64
	if parent.Time() == 0 {
		time = 10
	} else {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Istanbul, db ethdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Istanbul, db ethdb.Database, seed int) []*types.Block {
